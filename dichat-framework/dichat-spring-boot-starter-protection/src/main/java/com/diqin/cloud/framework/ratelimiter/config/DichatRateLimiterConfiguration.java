package com.diqin.cloud.framework.ratelimiter.config;

import com.diqin.cloud.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.diqin.cloud.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.diqin.cloud.framework.ratelimiter.core.keyresolver.impl.*;
import com.diqin.cloud.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class DichatRateLimiterConfiguration {
