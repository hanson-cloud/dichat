package com.diqin.cloud.framework.jackson.config;

import com.diqin.cloud.framework.common.util.json.JsonUtils;
import com.diqin.cloud.framework.common.util.json.databind.NumberSerializer;
import com.diqin.cloud.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.diqin.cloud.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class DichatJacksonAutoConfiguration {
