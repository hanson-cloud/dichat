package com.diqin.cloud.framework.web.config;
...
import com.diqin.cloud.framework.web.core.filter.CacheRequestBodyFilter;
import com.diqin.cloud.framework.web.core.filter.DemoFilter;
import com.diqin.cloud.framework.web.core.handler.GlobalExceptionHandler;
import com.diqin.cloud.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class DichatWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "dichat.demo", havingValue = "true")
