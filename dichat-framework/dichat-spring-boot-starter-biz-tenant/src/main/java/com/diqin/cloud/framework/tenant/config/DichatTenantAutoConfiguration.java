...
import com.diqin.cloud.framework.redis.config.DichatCacheProperties;
import com.diqin.cloud.framework.security.core.service.SecurityFrameworkService;
import com.diqin.cloud.framework.tenant.core.aop.TenantIgnore;
import com.diqin.cloud.framework.tenant.core.aop.TenantIgnoreAspect;
import com.diqin.cloud.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.diqin.cloud.framework.tenant.core.job.TenantJobAspect;
import com.diqin.cloud.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.diqin.cloud.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.diqin.cloud.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.diqin.cloud.framework.tenant.core.redis.TenantRedisCacheManager;
import com.diqin.cloud.framework.tenant.core.security.TenantSecurityWebFilter;
import com.diqin.cloud.framework.tenant.core.service.TenantFrameworkService;
import com.diqin.cloud.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.diqin.cloud.framework.tenant.core.web.TenantContextWebFilter;
import com.diqin.cloud.framework.tenant.core.web.TenantVisitContextInterceptor;
...
public class DichatTenantAutoConfiguration {
    ...
    @ConditionalOnClass(name = "com.diqin.cloud.framework.mq.redis.core.interceptor.RedisMessageInterceptor")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     DichatCacheProperties dichatCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(dichatCacheProperties.getRedisScanBatchSize()));
