 ...
 *      1）Spring Async：
 *          {@link com.diqin.cloud.framework.quartz.config.DichatAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 DichatSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.diqin.cloud.framework.tenant;
