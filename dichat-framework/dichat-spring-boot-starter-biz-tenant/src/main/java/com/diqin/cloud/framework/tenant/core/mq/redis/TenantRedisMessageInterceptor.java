package com.diqin.cloud.framework.tenant.core.mq.redis;

import cn.hutool.core.util.StrUtil;
import com.diqin.cloud.framework.mq.redis.core.interceptor.RedisMessageInterceptor;
import com.diqin.cloud.framework.mq.redis.core.message.AbstractRedisMessage;
import com.diqin.cloud.framework.tenant.core.context.TenantContextHolder;

import static com.diqin.cloud.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
