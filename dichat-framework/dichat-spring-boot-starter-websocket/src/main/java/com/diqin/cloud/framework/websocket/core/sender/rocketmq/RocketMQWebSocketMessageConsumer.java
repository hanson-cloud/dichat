package com.diqin.cloud.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${dichat.websocket.sender-rocketmq.topic}",
        consumerGroup = "${dichat.websocket.sender-rocketmq.consumer-group}",
