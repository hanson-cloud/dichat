package com.diqin.cloud.module.ai.framework.ai.core.model;
...
import com.diqin.cloud.framework.common.util.spring.SpringUtils;
import com.diqin.cloud.module.ai.enums.model.AiPlatformEnum;
import com.diqin.cloud.module.ai.framework.ai.config.AiAutoConfiguration;
import com.diqin.cloud.module.ai.framework.ai.config.DichatAiProperties;
...
import com.diqin.cloud.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.diqin.cloud.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            DichatAiProperties.Midjourney properties = SpringUtil.getBean(DichatAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(DichatAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        DichatAiProperties.DouBao properties = new DichatAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(DichatAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        DichatAiProperties.HunYuan properties = new DichatAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(DichatAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        DichatAiProperties.SiliconFlow properties = new DichatAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(DichatAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        DichatAiProperties.XingHuo properties = new DichatAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(DichatAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        DichatAiProperties.BaiChuan properties = new DichatAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(DichatAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        DichatAiProperties.Gemini properties = SpringUtil.getBean(DichatAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        DichatAiProperties.Grok properties = new DichatAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
