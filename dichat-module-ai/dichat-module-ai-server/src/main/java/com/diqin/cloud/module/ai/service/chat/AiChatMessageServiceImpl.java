package com.diqin.cloud.module.ai.service.chat;
...
import com.diqin.cloud.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.diqin.cloud.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.diqin.cloud.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.diqin.cloud.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.diqin.cloud.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.diqin.cloud.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.diqin.cloud.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.diqin.cloud.module.ai.dal.dataobject.model.AiChatRoleDO;
import com.diqin.cloud.module.ai.dal.dataobject.model.AiModelDO;
import com.diqin.cloud.module.ai.dal.dataobject.model.AiToolDO;
import com.diqin.cloud.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.diqin.cloud.module.ai.enums.ErrorCodeConstants;
...
import com.diqin.cloud.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.diqin.cloud.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.diqin.cloud.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.diqin.cloud.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.diqin.cloud.module.ai.service.model.AiChatRoleService;
import com.diqin.cloud.module.ai.service.model.AiModelService;
import com.diqin.cloud.module.ai.service.model.AiToolService;
import com.diqin.cloud.module.ai.util.AiUtils;
import com.diqin.cloud.module.ai.util.FileTypeUtils;
...
import static com.diqin.cloud.framework.common.pojo.CommonResult.error;
...
import static com.diqin.cloud.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.diqin.cloud.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 dichat.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 dichat.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
