package com.diqin.cloud.module.member.service.signin;
...
import com.diqin.cloud.module.member.controller.admin.signin.vo.record.MemberSignInRecordPageReqVO;
import com.diqin.cloud.module.member.controller.app.signin.vo.record.AppMemberSignInRecordSummaryRespVO;
import com.diqin.cloud.module.member.convert.signin.MemberSignInRecordConvert;
import com.diqin.cloud.module.member.dal.dataobject.signin.MemberSignInConfigDO;
import com.diqin.cloud.module.member.dal.dataobject.signin.MemberSignInRecordDO;
import com.diqin.cloud.module.member.dal.dataobject.user.MemberUserDO;
import com.diqin.cloud.module.member.dal.mysql.signin.MemberSignInRecordMapper;
import com.diqin.cloud.module.member.enums.MemberExperienceBizTypeEnum;
import com.diqin.cloud.module.member.enums.point.MemberPointBizTypeEnum;
import com.diqin.cloud.module.member.service.level.MemberLevelService;
import com.diqin.cloud.module.member.service.point.MemberPointRecordService;
import com.diqin.cloud.module.member.service.user.MemberUserService;
...
import static com.diqin.cloud.module.member.enums.ErrorCodeConstants.SIGN_IN_RECORD_TODAY_EXISTS;
