package com.diqin.cloud.module.member.controller.app.auth.vo;
...
public class AuthWeixinJsapiSignatureRespVO {
    ...
    @Schema(description = "URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.diqin.com")
    private String url;
