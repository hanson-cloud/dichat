package com.diqin.cloud.gateway.util;

import cn.hutool.core.map.MapUtil;
import com.diqin.cloud.framework.common.util.json.JsonUtils;
import com.diqin.cloud.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 *
 * copy from dichat-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 *
 * @author hanson
 */
@Slf4j
