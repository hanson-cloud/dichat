package com.diqin.cloud.gateway.filter.logging;
...
/**
 * 网关的访问日志过滤器
 * 从功能上，它类似 dichat-spring-boot-starter-web 的 ApiAccessLogFilter 过滤器
 * @author hanson
 */
@Slf4j
@Component
public class AccessLogFilter implements GlobalFilter, Ordered {
    ...
    private void writeAccessLog(AccessLog gatewayLog) {
        ...
        try {
            ...
            // 兜底处理，参见 https://gitee.com/zhijiantianya/dichat-cloud/issues/IC9A70
