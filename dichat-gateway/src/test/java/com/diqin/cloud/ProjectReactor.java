...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.diqin.cloud";
    private static final String ARTIFACT_ID = "dichat";
    private static final String PACKAGE_NAME = "com.diqin.cloud";
    private static final String TITLE = "后台管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.diqin.cloud";
        String artifactIdNew = "dichat";
        String packageNameNew = "com.diqin.cloud";
        String titleNew = "后台管理系统";
        String projectBaseDirNew = "D:\\project\\dichat"; // 一键改名后，“新”项目所在的目录
