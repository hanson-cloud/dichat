package com.diqin.cloud.module.system.api.social.dto;
...
public class SocialUserRespDTO {
    ...
    @Schema(description = "社交用户的头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.diqin.com/1.jpg")
