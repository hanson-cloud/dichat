...
public class LoginLogCreateReqDTO {
    ...
    @Schema(description = "用户账号", example = "dichat")
    ...
    @Schema(description = "终端类型，参见 TerminalEnum 枚举", example = "31")
    private Integer terminal;

    @Schema(description = "登录状态：1-在线 2-已离线 3-已强制下线，参见 LoginLogStatusEnum；不传则默认在线", example = "1")
