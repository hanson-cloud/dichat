package com.diqin.cloud.module.system.service.user;
...
import com.diqin.cloud.framework.common.util.collection.ArrayUtils;
import com.diqin.cloud.framework.common.util.collection.CollectionUtils;
import com.diqin.cloud.framework.test.core.ut.BaseDbUnitTest;
import com.diqin.cloud.module.infra.api.config.ConfigApi;
import com.diqin.cloud.module.infra.api.file.FileApi;
import com.diqin.cloud.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.diqin.cloud.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.diqin.cloud.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.diqin.cloud.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.diqin.cloud.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.diqin.cloud.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.diqin.cloud.module.system.dal.dataobject.dept.DeptDO;
import com.diqin.cloud.module.system.dal.dataobject.dept.PostDO;
import com.diqin.cloud.module.system.dal.dataobject.dept.UserPostDO;
import com.diqin.cloud.module.system.dal.dataobject.tenant.TenantDO;
import com.diqin.cloud.module.system.dal.dataobject.user.AdminUserDO;
import com.diqin.cloud.module.system.dal.mysql.dept.UserPostMapper;
import com.diqin.cloud.module.system.dal.mysql.user.AdminUserMapper;
import com.diqin.cloud.module.system.enums.common.SexEnum;
import com.diqin.cloud.module.system.mq.producer.user.AdminUserProducer;
import com.diqin.cloud.module.system.service.dept.DeptService;
import com.diqin.cloud.module.system.service.dept.PostService;
import com.diqin.cloud.module.system.service.oauth2.OAuth2TokenService;
import com.diqin.cloud.module.system.service.permission.PermissionService;
import com.diqin.cloud.module.system.service.tenant.TenantService;
...
import static com.diqin.cloud.framework.common.util.collection.SetUtils.asSet;
import static com.diqin.cloud.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.diqin.cloud.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.diqin.cloud.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.diqin.cloud.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.diqin.cloud.framework.test.core.util.AssertUtils.assertServiceException;
import static com.diqin.cloud.framework.test.core.util.RandomUtils.*;
import static com.diqin.cloud.module.system.enums.ErrorCodeConstants.*;
import static com.diqin.cloud.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("dichatyuanma"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("dichatyuanma");
        ...
        assertEquals("dichatyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("dichatyuanma"))).thenReturn("java");
