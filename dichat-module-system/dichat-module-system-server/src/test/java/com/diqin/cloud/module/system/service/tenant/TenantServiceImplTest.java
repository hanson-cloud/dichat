package com.diqin.cloud.module.system.service.tenant;

import com.diqin.cloud.framework.common.enums.CommonStatusEnum;
import com.diqin.cloud.framework.common.pojo.PageResult;
import com.diqin.cloud.framework.tenant.config.TenantProperties;
...
import com.diqin.cloud.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.diqin.cloud.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.diqin.cloud.module.system.dal.dataobject.permission.MenuDO;
...
import com.diqin.cloud.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.diqin.cloud.module.system.dal.mysql.tenant.TenantMapper;
import com.diqin.cloud.module.system.enums.permission.RoleCodeEnum;
import com.diqin.cloud.module.system.enums.permission.RoleTypeEnum;
import com.diqin.cloud.module.system.service.permission.MenuService;
...
import com.diqin.cloud.module.system.service.tenant.handler.TenantInfoHandler;
import com.diqin.cloud.module.system.service.tenant.handler.TenantMenuHandler;
import com.diqin.cloud.module.system.service.user.AdminUserService;
...
import static com.diqin.cloud.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        TenantSaveReqVO reqVO = randomPojo(TenantSaveReqVO.class, o -> {
            ...
            o.setWebsites(singletonList("https://www.diqin.com"));
            o.setUsername("yunai");
    ...
    public void testGetTenantPage() {
        ...
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> { // 等会查询到
            o.setName("帝秦科技");
            o.setContactName("hanson");
            o.setContactMobile("18392096183");
        ...
        reqVO.setName("帝秦");
        reqVO.setContactName("han");
        reqVO.setContactMobile("1839");
    ...
    public void testGetTenantByWebsite() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setWebsites(singletonList("https://www.diqin.com")));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByWebsite("https://www.diqin.com");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
