package com.diqin.cloud.module.system.service.permission;
...
import com.diqin.cloud.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import com.diqin.cloud.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import com.diqin.cloud.module.system.dal.dataobject.permission.MenuDO;
import com.diqin.cloud.module.system.dal.mysql.permission.MenuMapper;
import com.diqin.cloud.module.system.enums.permission.MenuTypeEnum;
...
import static com.diqin.cloud.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("hanson").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
        menuMapper.insert(cloneIgnoreId(menuDO, o -> o.setStatus(CommonStatusEnum.DISABLE.getStatus())));
        // 测试 name 不匹配
        menuMapper.insert(cloneIgnoreId(menuDO, o -> o.setName("son")));
        // 准备参数
        MenuListReqVO reqVO = new MenuListReqVO().setName("han").setStatus(CommonStatusEnum.ENABLE.getStatus());
