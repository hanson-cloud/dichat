...
import com.diqin.cloud.module.system.convert.oauth2.OAuth2OpenConvert;
...
import com.diqin.cloud.module.system.util.oauth2.OAuth2Utils;
...
import static com.diqin.cloud.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.diqin.com"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.diqin.com"),
