package com.diqin.cloud.module.system.service.social;
...
import com.diqin.cloud.framework.common.util.cache.CacheUtils;
import com.diqin.cloud.framework.common.util.http.HttpUtils;
import com.diqin.cloud.framework.common.util.object.BeanUtils;
import com.diqin.cloud.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.diqin.cloud.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.diqin.cloud.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.diqin.cloud.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.diqin.cloud.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.diqin.cloud.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.diqin.cloud.module.system.dal.dataobject.social.SocialClientDO;
import com.diqin.cloud.module.system.dal.mysql.social.SocialClientMapper;
import com.diqin.cloud.module.system.dal.redis.RedisKeyConstants;
import com.diqin.cloud.module.system.enums.social.SocialTypeEnum;
import com.diqin.cloud.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.diqin.cloud.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.diqin.cloud.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${dichat.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${dichat.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/dichat-cloud/pulls/230
