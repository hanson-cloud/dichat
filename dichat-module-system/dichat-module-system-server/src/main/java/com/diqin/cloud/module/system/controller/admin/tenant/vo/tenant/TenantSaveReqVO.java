package com.diqin.cloud.module.system.controller.admin.tenant.vo.tenant;
...
public class TenantSaveReqVO {
    ...
    @Schema(description = "联系人", requiredMode = Schema.RequiredMode.REQUIRED, example = "hanson")
    ...
    @Schema(description = "绑定域名数组", example = "https://www.diqin.com")
