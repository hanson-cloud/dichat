package com.diqin.cloud.module.product.api.comment.dto;
...
public class ProductCommentCreateReqDTO {
    ...
    @Schema(description = "评论图片地址数组，以逗号分隔最多上传 9 张", example = "https://www.diqin.com/xxx.jpg,http://www.diqin.com/yyy.jpg")
