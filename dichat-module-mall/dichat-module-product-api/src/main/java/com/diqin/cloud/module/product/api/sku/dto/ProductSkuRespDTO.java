package com.diqin.cloud.module.product.api.sku.dto;
...
public class ProductSkuRespDTO {
    ...
    @Schema(description = "图片地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.diqin.com/xxx.jpg")
