package com.diqin.cloud.module.product.controller.admin.spu.vo;
...
import com.diqin.cloud.framework.excel.core.convert.MoneyConvert;
import com.diqin.cloud.module.product.enums.DictTypeConstants;
...
public class ProductSpuRespVO {
    ...
    @Schema(description = "商品封面图", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.diqin.com/xx.png")
    @ExcelProperty("商品封面图")
    private String picUrl;

    @Schema(description = "商品轮播图", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.diqin.com/xx.png, https://www.diqin.com/xxx.png]")
