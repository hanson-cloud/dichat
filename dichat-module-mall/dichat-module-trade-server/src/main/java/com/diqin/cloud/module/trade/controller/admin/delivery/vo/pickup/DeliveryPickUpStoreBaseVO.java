package com.diqin.cloud.module.trade.controller.admin.delivery.vo.pickup;
...
public class DeliveryPickUpStoreBaseVO {
    ...
    @Schema(description = "门店 logo", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.diqin.com/1.png")
