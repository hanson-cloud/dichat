package com.diqin.cloud.module.trade.controller.app.aftersale.vo;
...
public class AppAfterSaleRespVO {
    ...
    @Schema(description = "商品图片", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.diqin.com/01.jpg")
