...
import com.diqin.cloud.framework.common.util.string.StrUtils;
...
import com.diqin.cloud.module.member.api.user.dto.MemberUserRespDTO;
import com.diqin.cloud.module.pay.api.order.dto.PayOrderCreateReqDTO;
import com.diqin.cloud.module.pay.enums.DictTypeConstants;
import com.diqin.cloud.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import com.diqin.cloud.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import com.diqin.cloud.module.product.api.sku.dto.ProductSkuRespDTO;
import com.diqin.cloud.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
...
import com.diqin.cloud.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import com.diqin.cloud.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import com.diqin.cloud.module.trade.controller.admin.order.vo.*;
import com.diqin.cloud.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import com.diqin.cloud.module.trade.controller.app.order.vo.*;
import com.diqin.cloud.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import com.diqin.cloud.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import com.diqin.cloud.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import com.diqin.cloud.module.trade.framework.order.config.TradeOrderProperties;
import com.diqin.cloud.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static com.diqin.cloud.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/dichatcode/dichat-mall-uniapp/issues/ICY7SJ
