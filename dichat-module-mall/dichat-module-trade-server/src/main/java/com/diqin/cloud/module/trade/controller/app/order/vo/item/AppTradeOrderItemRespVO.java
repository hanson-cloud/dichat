package com.diqin.cloud.module.trade.controller.app.order.vo.item;
...
public class AppTradeOrderItemRespVO {
    ...
    private Long spuId;
    @Schema(description = "商品 SPU 名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "hanson")
    ...
    @Schema(description = "商品图片", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.diqin.com/1.png")
