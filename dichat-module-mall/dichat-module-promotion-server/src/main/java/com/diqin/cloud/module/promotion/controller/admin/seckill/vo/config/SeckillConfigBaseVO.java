package com.diqin.cloud.module.promotion.controller.admin.seckill.vo.config;
...
public class SeckillConfigBaseVO {
    ...
    @Schema(description = "秒杀轮播图", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.diqin.com/xx.png]")
