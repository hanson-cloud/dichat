package com.diqin.cloud.module.promotion.controller.admin.kefu.vo.message;
...
public class KeFuMessageRespVO {
    ...
    @Schema(description = "发送人头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://dichat.com/images/avatar.jpg")
