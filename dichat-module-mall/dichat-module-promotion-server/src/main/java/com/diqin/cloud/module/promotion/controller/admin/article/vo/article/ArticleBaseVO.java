package com.diqin.cloud.module.promotion.controller.admin.article.vo.article;
...
public class ArticleBaseVO {
    ...
    @Schema(description = "文章封面图片地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.diqin.com")
