package com.diqin.cloud.module.promotion.controller.app.article.vo.category;
...
public class AppArticleCategoryRespVO {
    ...
    @Schema(description = "分类图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.diqin.com/1.png")
