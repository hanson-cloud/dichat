package com.diqin.cloud.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import com.diqin.cloud.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @Schema(description = "结果提示", example = "hanson，牛逼！")
    @ExcelProperty("结果提示")
