...
import com.diqin.cloud.framework.test.core.util.AssertUtils;
import com.diqin.cloud.module.infra.controller.admin.file.vo.file.FileCreateReqVO;
import com.diqin.cloud.module.infra.controller.admin.file.vo.file.FilePageReqVO;
import com.diqin.cloud.module.infra.dal.dataobject.file.FileDO;
import com.diqin.cloud.module.infra.dal.mysql.file.FileMapper;
...
import static com.diqin.cloud.module.infra.enums.ErrorCodeConstants.FILE_NOT_EXISTS;
import static com.diqin.cloud.module.infra.enums.ErrorCodeConstants.FILE_PATH_INVALID;
...
public class FileServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileByPresignedPath_success() {
        ...
        FileCreateReqVO reqVO = randomPojo(FileCreateReqVO.class, o -> {
            ...
            o.setName("test.jpg");
            o.setUrl("https://www.diqin.com/test.jpg?token=123");
        });
        ...
        assertEquals("https://www.diqin.com/test.jpg", file.getUrl());
    }
