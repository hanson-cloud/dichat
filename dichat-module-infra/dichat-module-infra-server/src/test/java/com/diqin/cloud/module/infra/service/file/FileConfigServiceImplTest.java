package com.diqin.cloud.module.infra.service.file;
...
import com.diqin.cloud.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import com.diqin.cloud.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import com.diqin.cloud.module.infra.dal.dataobject.file.FileConfigDO;
import com.diqin.cloud.module.infra.dal.mysql.file.FileConfigMapper;
import com.diqin.cloud.module.infra.framework.file.core.client.FileClient;
...
import com.diqin.cloud.module.infra.framework.file.core.client.local.LocalFileClient;
import com.diqin.cloud.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.diqin.cloud.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static com.diqin.cloud.framework.test.core.util.RandomUtils.randomLongId;
import static com.diqin.cloud.framework.test.core.util.RandomUtils.randomPojo;
import static com.diqin.cloud.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.diqin.cloud.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        ...
        Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai")
                .put("domain", "https://www.diqin.com").build();
        ...
        assertEquals("https://www.diqin.com", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                .setConfig(new LocalFileClientConfig().setBasePath("/yunai").setDomain("https://www.diqin.com")));
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("hanson")
        ...
        // 测试 name 不匹配
        fileConfigMapper.insert(cloneIgnoreId(dbFileConfig, o -> o.setName("son")));
        // 测试 storage 不匹配
    ...
    public void testFileConfig() throws Exception {
        ...
        when(fileClient.upload(any(), any(), any())).thenReturn("https://www.diqin.com");

        // 调用，并断言
        assertEquals("https://www.diqin.com", fileConfigService.testFileConfig(id));
    }
