package com.diqin.cloud.module.infra.service.logger;
...
import com.diqin.cloud.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.diqin.cloud.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.diqin.cloud.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.diqin.cloud.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.diqin.cloud.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.diqin.cloud.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("dichat-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("dichat-test");
