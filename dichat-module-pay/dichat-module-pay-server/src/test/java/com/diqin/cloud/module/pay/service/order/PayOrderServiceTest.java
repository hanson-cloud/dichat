package com.diqin.cloud.module.pay.service.order;

import cn.hutool.extra.spring.SpringUtil;
import com.diqin.cloud.framework.common.pojo.PageResult;
import com.diqin.cloud.framework.test.core.ut.BaseDbAndRedisUnitTest;
import com.diqin.cloud.module.pay.api.order.dto.PayOrderCreateReqDTO;
import com.diqin.cloud.module.pay.controller.admin.order.vo.PayOrderExportReqVO;
import com.diqin.cloud.module.pay.controller.admin.order.vo.PayOrderPageReqVO;
import com.diqin.cloud.module.pay.controller.admin.order.vo.PayOrderSubmitReqVO;
import com.diqin.cloud.module.pay.controller.admin.order.vo.PayOrderSubmitRespVO;
import com.diqin.cloud.module.pay.dal.dataobject.app.PayAppDO;
...
import com.diqin.cloud.module.pay.dal.dataobject.order.PayOrderExtensionDO;
import com.diqin.cloud.module.pay.dal.mysql.order.PayOrderExtensionMapper;
import com.diqin.cloud.module.pay.dal.mysql.order.PayOrderMapper;
import com.diqin.cloud.module.pay.dal.redis.no.PayNoRedisDAO;
import com.diqin.cloud.module.pay.enums.PayChannelEnum;
import com.diqin.cloud.module.pay.enums.notify.PayNotifyTypeEnum;
import com.diqin.cloud.module.pay.enums.order.PayOrderStatusEnum;
import com.diqin.cloud.module.pay.framework.pay.config.PayProperties;
import com.diqin.cloud.module.pay.framework.pay.core.client.PayClient;
import com.diqin.cloud.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO;
import com.diqin.cloud.module.pay.framework.pay.core.enums.PayOrderDisplayModeEnum;
import com.diqin.cloud.module.pay.service.app.PayAppService;
import com.diqin.cloud.module.pay.service.channel.PayChannelService;
import com.diqin.cloud.module.pay.service.notify.PayNotifyService;
...
import static com.diqin.cloud.framework.common.util.date.LocalDateTimeUtils.*;
...
import static com.diqin.cloud.module.pay.enums.ErrorCodeConstants.*;
...
public class PayOrderServiceTest extends BaseDbAndRedisUnitTest {
    ...
    public void testCreateOrder_success() {
        ...
        assertEquals(1L, order.getAppId());
        assertEquals("http://127.0.0.1", order.getNotifyUrl());
        assertEquals(order.getStatus(), PayOrderStatusEnum.WAITING.getStatus());
        assertEquals(0, order.getRefundPrice());
    }
