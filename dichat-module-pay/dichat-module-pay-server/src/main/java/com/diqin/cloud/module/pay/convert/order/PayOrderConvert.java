package com.diqin.cloud.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.diqin.cloud.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
