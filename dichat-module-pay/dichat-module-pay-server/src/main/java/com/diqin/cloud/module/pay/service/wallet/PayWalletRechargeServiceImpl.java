...
import com.diqin.cloud.module.pay.dal.mysql.wallet.PayWalletRechargeMapper;
...
import static com.diqin.cloud.framework.common.util.number.MoneyUtils.fenToYuanStr;
import static com.diqin.cloud.module.pay.convert.wallet.PayWalletRechargeConvert.INSTANCE;
import static com.diqin.cloud.module.pay.enums.ErrorCodeConstants.*;
import static com.diqin.cloud.module.pay.enums.MessageTemplateConstants.WXA_WALLET_RECHARGER_PAID;
import static com.diqin.cloud.module.pay.enums.refund.PayRefundStatusEnum.*;
...
public class PayWalletRechargeServiceImpl implements PayWalletRechargeService {
    ...
    @Override
    public PageResult<PayWalletRechargeDO> getWalletRechargeAdminPage(PageParam pageReqVO, Boolean payStatus, LocalDateTime[] createTime) {
        return walletRechargeMapper.selectAdminPage(pageReqVO, payStatus, createTime);
    }
