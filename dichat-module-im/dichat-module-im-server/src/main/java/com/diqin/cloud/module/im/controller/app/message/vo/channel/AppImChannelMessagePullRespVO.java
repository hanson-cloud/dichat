package com.diqin.cloud.module.im.controller.app.message.vo.channel;
...
@Data
public class AppImChannelMessagePullRespVO {
    ...
    @Schema(description = "频道名称（冗余频道表，便于 App 列表直接展示）")
    private String channelName;

    @Schema(description = "频道头像（冗余频道表，便于 App 列表直接展示）")
