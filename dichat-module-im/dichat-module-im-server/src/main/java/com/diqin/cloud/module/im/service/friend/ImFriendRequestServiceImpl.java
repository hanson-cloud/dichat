...
import com.diqin.cloud.module.im.enums.friend.ImFriendRequestHandleResultEnum;
...
import com.diqin.cloud.module.im.service.websocket.dto.notification.friend.FriendRequestApprovedNotification;
import com.diqin.cloud.module.im.service.websocket.dto.notification.friend.FriendRequestNotification;
import com.diqin.cloud.module.im.service.websocket.dto.notification.friend.FriendRequestRejectedNotification;
...
public class ImFriendRequestServiceImpl implements ImFriendRequestService {
    ...
    public ImFriendRequestDO applyFriend(Long fromUserId, AppImFriendRequestApplyReqVO reqVO) {
        ...
        // 1.2 校验对方存在且启用
        userService.validateUser(toUserId);
        ...
        ImUserDO fromUser = userService.getUser(fromUserId);
     ...
     * @return 申请记录
     */
    private ImFriendRequestDO createOrResetRequest(Long fromUserId, AppImFriendRequestApplyReqVO reqVO) {
        Long toUserId = reqVO.getToUserId();
    ...
    public void agreeFriendRequest(Long userId, Long requestId) {
        ...
        // 1.2 复验双方用户有效
        userService.validateUserList(List.of(request.getFromUserId(), request.getToUserId()));
