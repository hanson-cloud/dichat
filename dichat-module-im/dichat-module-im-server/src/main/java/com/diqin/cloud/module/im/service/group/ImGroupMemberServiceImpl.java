...
import static com.diqin.cloud.module.im.dal.redis.RedisKeyConstants.GROUP_MEMBER_IDS;
...
public class ImGroupMemberServiceImpl implements ImGroupMemberService {
    ...
    @Override
    public void updateGroupMember(Long userId, AppImGroupMemberUpdateReqVO updateReqVO) {
    ...
    public List<ImGroupMemberDO> getGroupMembers(Long groupId) {
        ImGroupDO group = imGroupService.getGroup(groupId);
        return groupMemberMapper.selectListByGroupId(group.getId());
    }
