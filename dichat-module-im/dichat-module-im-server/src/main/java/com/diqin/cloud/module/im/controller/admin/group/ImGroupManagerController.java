...
import com.diqin.cloud.module.im.controller.admin.group.vo.ImGroupManagerRespVO;
...
public class ImGroupManagerController {
    ...
    public CommonResult<PageResult<ImGroupManagerRespVO>> getGroupPage(@Valid ImGroupManagerPageReqVO pageReqVO) {
        ...
        // 2.1 批量查询相关数据
        List<ImUserDO> userList = userService.getUserList(convertSet(pageResult.getList(), ImGroupDO::getOwnerUserId));
