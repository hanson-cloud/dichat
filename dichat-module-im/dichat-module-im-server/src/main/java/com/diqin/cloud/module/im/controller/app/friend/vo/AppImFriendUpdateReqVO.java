package com.diqin.cloud.module.im.controller.app.friend.vo;
...
@Data
public class AppImFriendUpdateReqVO {
    ...
    @Schema(description = "备注电话（多号逗号分隔，仅自己可见）；不传表示不修改，传空串表示清空", example = "13800001111,13900002222")
    @Size(max = 255, message = "备注电话最多 255 个字符")
    private String phone;

    @Schema(description = "文字备注（仅自己可见）；不传表示不修改，传空串表示清空", example = "大学同学")
    @Size(max = 500, message = "文字备注最多 500 个字符")
