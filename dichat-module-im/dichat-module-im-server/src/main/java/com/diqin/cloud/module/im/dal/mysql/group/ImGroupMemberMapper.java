...
public interface ImGroupMemberMapper extends BaseMapperX<ImGroupMemberDO> {
     ...
     * 管理后台分页查询群成员
     */
    default PageResult<ImGroupMemberDO> selectPage(ImGroupMemberManagerPageReqVO reqVO) {
        return selectPage(reqVO, new LambdaQueryWrapperX<ImGroupMemberDO>()
                ...
                .eqIfPresent(ImGroupMemberDO::getRole, reqVO.getRole())
                .eqIfPresent(ImGroupMemberDO::getStatus, reqVO.getStatus())
                .likeIfPresent(ImGroupMemberDO::getDisplayUserName, reqVO.getDisplayUserName())
