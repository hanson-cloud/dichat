...
public class AppImFriendRespVO {
    ...
    @Schema(description = "备注电话（多号逗号分隔，仅自己可见）", example = "13800001111,13900002222")
    private String phone;

    @Schema(description = "文字备注（仅自己可见）", example = "大学同学")
    ...
    @Schema(description = "好友昵称的拼音（小写无空格）", example = "dichat")
    private String nicknamePinyin;

    @Schema(description = "好友头像（实时聚合自 AdminUser）")
    private String avatar;

    @Schema(description = "对方已读到我发的最大消息编号（用于已读回执）", example = "100")
