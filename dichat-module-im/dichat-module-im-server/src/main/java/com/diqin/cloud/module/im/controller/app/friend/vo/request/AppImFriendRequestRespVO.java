package com.diqin.cloud.module.im.controller.app.friend.vo.request;
...
@Data
public class AppImFriendRequestRespVO {
    ...
    @Schema(description = "发起方账号（实时聚合自 AdminUser）", example = "admin")
    ...
    @Schema(description = "接收方账号（实时聚合自 AdminUser）", example = "user001")
