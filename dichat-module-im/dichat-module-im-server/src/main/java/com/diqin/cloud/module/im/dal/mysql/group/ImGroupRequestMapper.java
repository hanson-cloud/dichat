...
public interface ImGroupRequestMapper extends BaseMapperX<ImGroupRequestDO> {
     ...
     */
    default void updateApplyByIdReset(Long id, String applyContent, Integer addSource, LocalDateTime updateTime) {
        update(null, new LambdaUpdateWrapper<ImGroupRequestDO>()
    ...
    default void updateInviteByIdReset(Long id, Long inviterUserId, Integer addSource, LocalDateTime updateTime) {
        update(null, new LambdaUpdateWrapper<ImGroupRequestDO>()
                .eq(ImGroupRequestDO::getId, id)
