package com.diqin.cloud.module.im.service.websocket.dto.notification.rtc;
...
public class ImRtcCallNotification {
     ...
     * @return INVITE 信令
     */
    public static ImRtcCallNotification ofInvite(ImRtcCallDO call, ImUserDO inviter,
     ...
     * @return REJECT 信令
     */
    public static ImRtcCallNotification ofReject(ImRtcCallDO call, Long operatorUserId, ImUserDO operator) {
     ...
     * @return NO_ANSWER 信令
     */
    public static ImRtcCallNotification ofNoAnswer(ImRtcCallDO call, Long operatorUserId, ImUserDO operator) {
