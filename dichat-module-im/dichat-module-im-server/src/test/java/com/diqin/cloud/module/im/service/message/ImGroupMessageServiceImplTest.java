...
public class ImGroupMessageServiceImplTest extends BaseMockitoUnitTest {
    ...
    private AppImGroupMessageSendReqVO buildSendReqVO() {
        AppImGroupMessageSendReqVO reqVO = new AppImGroupMessageSendReqVO();
    ...
    public void testSendMessage_success() {
        try (MockedStatic<SpringUtil> springUtilMockedStatic = mockStatic(SpringUtil.class)) {
            ...
            // 准备
            AppImGroupMessageSendReqVO reqVO = buildSendReqVO();
    ...
    public void testSendMessage_notInGroup() {
        ...
        when(groupMemberService.validateMemberInGroup(10L, 1L))
                .thenThrow(new ServiceException(GROUP_MEMBER_NOT_IN_GROUP.code(), GROUP_MEMBER_NOT_IN_GROUP.msg()));

        // 调用并断言
        ServiceException exception = assertThrows(ServiceException.class,
                () -> groupMessageService.sendGroupMessage(1L, reqVO));
        assertEquals(GROUP_MEMBER_NOT_IN_GROUP.code(), exception.getCode());
    }
    ...
    public void testPullMessages_atFieldCorrectReturn() {
        ...
        // 断言：@ 字段正确返回
        assertEquals(1, result.size());
        assertEquals(List.of(1L, 3L), result.getFirst().getAtUserIds());
    }
    ...
    public void testPullMessages_receiptReadCountForSender() {
        ...
        assertEquals(1, result.size());
        assertEquals(1, result.getFirst().getReadCount());
    }
    ...
    public void testReadGroupMessages_disabled() {
        ...
        ServiceException exception = assertThrows(ServiceException.class,
                () -> groupMessageService.readGroupMessages(1L, 10L, 100L));
        assertEquals(MESSAGE_GROUP_READ_DISABLED.code(), exception.getCode());
        // 断言：Redis 不写、不推送
    ...
    public void testReadGroupMessages_messageNotInGroup() {
        ...
        ServiceException exception = assertThrows(ServiceException.class,
                () -> groupMessageService.readGroupMessages(1L, 10L, 100L));
        assertEquals(MESSAGE_NOT_IN_GROUP.code(), exception.getCode());
        verify(groupMessageReadRedisDAO, never()).updateReadMaxMessageId(anyLong(), anyLong(), anyLong());
    }
    ...
    public void testGetGroupMessageList_delegatesToMapperWithJoinTime() {
        ...
        AppImGroupMessageListReqVO reqVO = new AppImGroupMessageListReqVO();
        reqVO.setGroupId(10L);
        reqVO.setMaxId(100L);
        reqVO.setLimit(20);
    ...
    public void testGetGroupMessageList_notInGroup() {
        ...
        reqVO.setLimit(20);
        when(groupMemberService.validateMemberInGroup(10L, 1L))
                .thenThrow(new ServiceException(GROUP_MEMBER_NOT_IN_GROUP.code(),
                        GROUP_MEMBER_NOT_IN_GROUP.msg()));
