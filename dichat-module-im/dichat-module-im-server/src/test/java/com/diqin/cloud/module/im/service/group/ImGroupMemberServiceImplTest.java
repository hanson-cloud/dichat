...
public class ImGroupMemberServiceImplTest extends BaseMockitoUnitTest {
    ...
    @Mock
    private com.diqin.cloud.module.im.service.message.ImGroupMessageService groupMessageService;
    ...
    public void testAddGroupMembers_mixedInsertAndUpdate() {
        ...
        verify(groupMemberMapper).insertBatch(argThat((List<ImGroupMemberDO> list) ->
                list.size() == 1 && list.getFirst().getUserId().equals(2L)));
    }
    ...
    public void testUpdateGroupMember_success() {
        ...
        AppImGroupMemberUpdateReqVO reqVO = new AppImGroupMemberUpdateReqVO()
        ...
        verify(groupMessageService).sendGroupMessage(eq(1L), any(com.diqin.cloud.module.im.service.message.dto.ImGroupMessageSendDTO.class));
        ...
        verify(groupMessageService).sendGroupMessage(eq(1L), eq(java.util.List.of(1L)),
                any(com.diqin.cloud.module.im.service.message.dto.ImGroupMessageSendDTO.class));
    }
