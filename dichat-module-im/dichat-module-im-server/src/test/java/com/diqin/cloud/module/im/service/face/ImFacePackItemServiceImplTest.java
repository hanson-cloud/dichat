package com.diqin.cloud.module.im.service.face;
...
import com.diqin.cloud.module.im.controller.admin.face.vo.item.ImFacePackItemSaveReqVO;
...
import com.diqin.cloud.module.im.dal.mysql.face.ImFacePackItemMapper;
...
import static com.diqin.cloud.module.im.enums.ErrorCodeConstants.FACE_PACK_ITEM_NOT_EXISTS;
import static com.diqin.cloud.module.im.enums.ErrorCodeConstants.FACE_PACK_NOT_EXISTS;
...
public class ImFacePackItemServiceImplTest extends BaseMockitoUnitTest {
    ...
    public void testCreateFacePackItem_packNotExists() {
        ...
        when(facePackService.validateFacePackExists(99L))
                .thenThrow(new ServiceException(FACE_PACK_NOT_EXISTS.code(), FACE_PACK_NOT_EXISTS.msg()));
    ...
    public void testUpdateFacePackItem_itemNotExists() {
        ...
        ServiceException exception = assertThrows(ServiceException.class,
                () -> service.updateFacePackItem(reqVO));
        assertEquals(FACE_PACK_ITEM_NOT_EXISTS.code(), exception.getCode());
