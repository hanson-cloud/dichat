...
public class ImFriendRequestServiceImplTest extends BaseMockitoUnitTest {
    ...
    public void testApplyFriend_addSelf() {
        // 准备：发起人 = 接收人
        AppImFriendRequestApplyReqVO reqVO = new AppImFriendRequestApplyReqVO();
        reqVO.setToUserId(1L);

        // 调用 + 断言
        ServiceException exception = assertThrows(ServiceException.class,
                () -> friendRequestService.applyFriend(1L, reqVO));
        assertEquals(FRIEND_ADD_SELF.code(), exception.getCode());
    }
    ...
    public void testApplyFriend_alreadyFriend() {
        ...
        ServiceException exception = assertThrows(ServiceException.class,
                () -> friendRequestService.applyFriend(1L, reqVO));
        assertEquals(FRIEND_REQUEST_ALREADY_FRIEND.code(), exception.getCode());
    }
    ...
    public void testApplyFriend_blockedByPeer() {
        ...
        ServiceException exception = assertThrows(ServiceException.class,
                () -> friendRequestService.applyFriend(1L, reqVO));
        assertEquals(FRIEND_REQUEST_BLOCKED_BY_PEER.code(), exception.getCode());
    }
    ...
    public void testApplyFriend_insertNew() {
        ...
        when(userService.getUser(1L)).thenReturn(new ImUserDO().setNickname("张三").setAvatar("a.png"));
    ...
    public void testAgreeFriendRequest_success() {
        ...
        verify(userService).validateUserList(ListUtil.of(1L, 2L));
    ...
    public void testAgreeFriendRequest_notExists() {
        ...
        ServiceException exception = assertThrows(ServiceException.class,
                () -> friendRequestService.agreeFriendRequest(2L, 100L));
        assertEquals(FRIEND_REQUEST_NOT_EXISTS.code(), exception.getCode());
    }
    ...
    public void testAgreeFriendRequest_notToMe() {
        ...
        assertEquals(FRIEND_REQUEST_NOT_TO_ME.code(), exception.getCode());
    }
    ...
    public void testAgreeFriendRequest_alreadyHandled() {
        ...
        ServiceException exception = assertThrows(ServiceException.class,
                () -> friendRequestService.agreeFriendRequest(2L, 100L));
        assertEquals(FRIEND_REQUEST_HANDLED.code(), exception.getCode());
    }
