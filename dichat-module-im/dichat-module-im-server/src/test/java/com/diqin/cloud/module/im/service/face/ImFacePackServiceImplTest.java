...
import com.diqin.cloud.module.im.controller.admin.face.vo.pack.ImFacePackSaveReqVO;
import com.diqin.cloud.module.im.dal.dataobject.face.ImFacePackDO;
import com.diqin.cloud.module.im.dal.mysql.face.ImFacePackMapper;
...
import static com.diqin.cloud.module.im.enums.ErrorCodeConstants.FACE_PACK_HAS_ITEMS;
...
public class ImFacePackServiceImplTest extends BaseMockitoUnitTest {
    ...
    public void testValidateFacePackExists_notFound() {
        ...
        assertEquals(FACE_PACK_NOT_EXISTS.code(), exception.getCode());
    }
    ...
    public void testDeleteFacePack_hasItems() {
        ...
        assertEquals(FACE_PACK_HAS_ITEMS.code(), exception.getCode());
