...
public class ImRtcCallServiceImplTest extends BaseMockitoUnitTest {
    ...
    public void testTimeoutInvitingParticipants_emptyCandidates_returnsZeroAndNoDownstream() {
        ...
        verifyNoInteractions(userService, rtcCallMapper, webSocketService);
    }
    ...
    public void testTimeoutInvitingParticipants_casAllFails_noPushNoEndSession() {
        ...
        when(userService.getUserMap(anySet())).thenReturn(Map.of(100L, buildUser(100L)));
    ...
    public void testNoAnswerCallCheck_authFails_silentNoOp() {
        ...
        verifyNoInteractions(userService, webSocketService);
    }
    ...
    public void testNoAnswerCallCheck_groupCall_pushesNoAnswer() {
        ...
        when(userService.getUserMap(anySet())).thenReturn(Map.of(101L, buildUser(101L)));
    ...
    public void testCreateCall_groupOnlyInviteSelf_throwInviteeRequired() throws Exception {
        ...
        AppImRtcCallCreateReqVO reqVO = new AppImRtcCallCreateReqVO();
        ...
        assertEquals(RTC_GROUP_INVITEE_REQUIRED.code(), exception.getCode());
    ...
    public void testAcceptCall_joinedOtherRoom_throwSelfBusy() {
        ...
        assertEquals(RTC_SELF_BUSY.code(), exception.getCode());
    ...
    public void testInviteCall_overLimit_throws() throws Exception {
        ...
        AppImRtcCallInviteReqVO reqVO = new AppImRtcCallInviteReqVO();
        reqVO.setRoom("r1");
        ...
        assertEquals(RTC_GROUP_INVITEE_OVER_LIMIT.code(), exception.getCode());
        verify(rtcParticipantMapper, never()).insertBatch(anyList());
    }
    ...
    private ImUserDO buildUser(Long id) {
