package com.diqin.cloud.module.im.service.sensitiveword;
...
import com.diqin.cloud.module.im.dal.mysql.sensitiveword.ImSensitiveWordMapper;
...
public class ImSensitiveWordServiceImplTest extends BaseMockitoUnitTest {
    ...
    public void testCreateSensitiveWord_duplicateWord_throws() {
        ...
        ServiceException exception = assertThrows(ServiceException.class,
                () -> sensitiveWordService.createSensitiveWord(reqVO));
        assertEquals(SENSITIVE_WORD_DUPLICATED.code(), exception.getCode());
    ...
    public void testDeleteSensitiveWord_notExists_throws() {
        ...
        assertEquals(SENSITIVE_WORD_NOT_EXISTS.code(), exception.getCode());
