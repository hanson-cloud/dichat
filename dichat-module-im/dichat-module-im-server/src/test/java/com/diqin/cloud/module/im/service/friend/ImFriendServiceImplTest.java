...
import static com.diqin.cloud.module.im.enums.ErrorCodeConstants.FRIEND_NOT_FRIEND;
...
public class ImFriendServiceImplTest extends BaseMockitoUnitTest {
    ...
    public void testUpdateFriend_success() {
        // 准备
        AppImFriendUpdateReqVO reqVO = new AppImFriendUpdateReqVO();
    ...
    public void testGetMutualEnableFriendList_filterSingleSideDeleted() {
        ...
        assertEquals(2L, result.getFirst().getFriendUserId());
    }
